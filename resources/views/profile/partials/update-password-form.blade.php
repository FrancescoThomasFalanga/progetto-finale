<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mb-2">
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="current_password">{{__('Current Password')}}</label>
        ...
        <div class="mb-2">
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="password">{{__('New Password')}}</label>
        ...
        <div class="mb-2">
            ...
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="password_confirmation">{{__('Confirm Password')}}</label>

<section>
    <header class="d-flex flex-column gap-2 align-items-start">
        <h2 class="text-lg font-medium text-gray-900 label-bg text-white p-2">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mb-2">
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="current_password">{{__('Vecchia Password')}}</label>
        ...
        <div class="mb-2">
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="password">{{__('Nuova Password')}}</label>
        ...
        <div class="mb-2">
            ...
            <label class="text-white fw-bold label-bg py-1 mt-2 mb-1" for="password_confirmation">{{__('Conferma Password')}}</label>

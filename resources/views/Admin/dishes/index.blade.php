    ...
    <div class="container d-flex gap-4 py-4 ">
        ...
        @foreach ($dishes as $dish)
            <div class="card" style="width: 18rem;">
                @if (
                    $dish->cover_image !=
                        'https://static.vecteezy.com/ti/vettori-gratis/p1/5359703-cibo-icone-pixel-perfetto-illustrazione-vettoriale.jpg')
        ...
        <div class="modal fade text-primary" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
